...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/misskey.git`).
...
- When committing your changes, make sure that each commit message is clear
  (e.g. `git commit -m 'Take in an optional something as a parameter to misskey'`).
- Push your new branch to your own fork into the same remote branch
  (e.g. `git push origin my-username.my-new-feature`, replace `origin` if you use another remote.)

### 1.3.2. Open a pull request

Go to the [pull request page of misskey][prs] and in the top
...
- fix: Avoid execute something in `MisskeyApi`
- docs: Add a example
- docs: Improve the README
- test: Add test for `account.dart`
- refactor: Optimize the structure of `MisskeyClient`

[github issue]: https://github.com/misskey-dart/misskey/issues/new
[github issues]: https://github.com/misskey-dart/misskey/issues/new
[prs]: https://github.com/misskey-dart/misskey/pulls
